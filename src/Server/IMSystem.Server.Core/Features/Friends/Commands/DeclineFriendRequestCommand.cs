...
/// 拒绝好友请求的命令。
/// </summary>
public class DeclineFriendRequestCommand : IRequest<Result> // 返回 Result 表示操作成功或失败
{
    /// <summary>
    /// 要拒绝的好友请求的ID (即 FriendshipId)。
    /// </summary>
    ...
    public DeclineFriendRequestCommand(Guid friendshipId, Guid currentUserId)
    {
