...
{
    /// <inheritdoc />
    public partial class AddBlockedFieldsToFriendship : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReaderUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccessUrl = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FileMetadatas_Users_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FriendGroups_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequesterRemark = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    AddresseeRemark = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    RequestExpiresAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LastModifiedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Friendships_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnnouncementSetAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    AnnouncementSetByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastModifiedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_StateOrProvince = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ...
                    AllowSearchability = table.Column<bool>(type: "bit", nullable: false),
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFriendGroups", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFriendGroups_Friendships_FriendshipId",
                        column: x => x.FriendshipId,
                        principalTable: "Friendships",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFriendGroups_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NicknameInGroup = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastModifiedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SequenceNumber = table.Column<long>(type: "bigint", nullable: false, defaultValue: 0L),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileMetadatas_CreatedBy",
                table: "FileMetadatas",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_FileMetadatas_StoredFileName",
                table: "FileMetadatas",
                column: "StoredFileName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FriendGroups_CreatedBy_IsDefault",
                table: "FriendGroups",
                columns: new[] { "CreatedBy", "IsDefault" });

            migrationBuilder.CreateIndex(
                name: "IX_FriendGroups_CreatedBy_Name",
                table: "FriendGroups",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Friendships_CreatedBy_AddresseeId",
                table: "Friendships",
                columns: new[] { "CreatedBy", "AddresseeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GroupInvitations_Group_InvitedUser_Status",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageReadReceipts_MessageId_ReaderUserId",
                table: "MessageReadReceipts",
                columns: new[] { "MessageId", "ReaderUserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MessageReadReceipts_ReaderUserId",
                table: "MessageReadReceipts",
                column: "ReaderUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_RecipientId_RecipientType",
                table: "Messages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFriendGroups_CreatedBy_FriendshipId",
                table: "UserFriendGroups",
                columns: new[] { "CreatedBy", "FriendshipId" },
                unique: true)
                .Annotation("SqlServer:Include", new[] { "FriendGroupId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFriendGroups_FriendshipId",
                table: "UserFriendGroups",
                column: "FriendshipId");
